...
game.onUpdateInterval(375, function () {
    if (blockMenu.isMenuOpen() == false && Pause == false && (Round >= 5 && Round <= 6)) {
        spawnHive(Hive)
        spawnHive(Hive2)
        spawnHive(Hive3)
        if (Round >= 6) {
...
game.onUpdateInterval(225, function () {
    if (blockMenu.isMenuOpen() == false && Pause == false && Round >= 9) {
        spawnHive(Hive)
        spawnHive(Hive2)
        spawnHive(Hive3)
        if (Round >= 6) {
...
game.onUpdateInterval(450, function () {
    if (blockMenu.isMenuOpen() == false && Pause == false && (Round >= 3 && Round <= 4)) {
        spawnHive(Hive)
        spawnHive(Hive2)
        spawnHive(Hive3)
    }
...
game.onUpdateInterval(500, function () {
    if (blockMenu.isMenuOpen() == false && Pause == false && Round <= 2) {
        spawnHive(Hive)
        spawnHive(Hive2)
        spawnHive(Hive3)
    }
...
game.onUpdateInterval(300, function () {
    if (blockMenu.isMenuOpen() == false && Pause == false && (Round >= 7 && Round <= 8)) {
        spawnHive(Hive)
        spawnHive(Hive2)
        spawnHive(Hive3)
        if (Round >= 6) {
